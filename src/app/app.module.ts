...
@NgModule({
  declarations: [
    ...
    OfferSidebar,
    Contact , ProductDetails , TicketsComponent , MailComponent , OrdersComponent, CheckoutComponent , CheckoutNavbar , ForgotPassword
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
    ...
    UserService , AdminService , ItemsService, UserLoginGuard, CheckoutGuard,
